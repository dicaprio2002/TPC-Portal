<?php
    ...
    $sql = "SELECT company_name, email, job_description, role_offered, essentail_skills, salary_package, recruiting_since FROM Company WHERE email = '".$_SESSION['email']."'";
...
<table>
	...
	<tr>
		...
		<td><?php echo $row['essentail_skills']; ?></td>
    </tr>
	<tr>
