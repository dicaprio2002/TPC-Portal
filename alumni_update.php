...
$sql = "UPDATE Alumni SET name='$name', password='$password', marks='$marks', cpi='$cpi', age='$age', dept='$dept', branch='$branch',year='$year', location='$location',area='$area',position='$position',placedIitp='$placedIitp' WHERE rollNo='$rollNo';";
